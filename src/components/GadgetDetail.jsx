...
const GadgetDetail = () => {
    ...
    const gadget = data.find(gadget => gadget.productId === Id)
            ...
            <p className="pb-8 text-white w-[30rem] lg:w-[48rem] mx-auto font-light text-base">Explore the latest gadgets that will take your experience to the next level. From smart 
                ...
                <div className="relative md:w-[45rem] md:h-[30rem] mx-auto lg:w-[70rem] lg:h-[35rem] flex flex-col md:flex-row justify-between items-center bg-white p-8 rounded-3xl">
                    ...
                    <div className='flex items-center mt-2 space-x-4'>
                        <button className='btn px-3 rounded-r-full rounded-l-full text-white font-bold text-base lg:text-lg bg-purple-600'>Add to Cart <TbShoppingCart className='text-xl lg:text-2xl' /></button>
                        <button className='btn btn-ghost border border-black border-opacity-15 btn-circle'><FaRegHeart className='text-lg' /></button>
                    </div>
