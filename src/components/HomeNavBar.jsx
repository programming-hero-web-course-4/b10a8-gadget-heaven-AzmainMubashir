    ...
    return (
        <div className="px-10 mx-auto pt-6 mb-[28rem] bg-[#F7F7F7]">
                  ...
                  <div className="dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle bg-white">
                      <div className="indicator">
                        ...
                        <span className="badge badge-sm absolute -top-3 -right-5">0</span>
                      </div>
                    </div>
                    <div
                      tabIndex={0}
              ...
              <div className="hero bg-purple-600 h-[40rem] items-start pt-10 rounded-b-[2rem]">
                      ...
                      <div className="relative top-[24rem] border-4 border-white rounded-[2rem] p-6 bg-white bg-opacity-30">
